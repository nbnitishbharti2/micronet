				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-md-2 text-right">
							<a href="{!! route('admin.view.type') !!}" class="btn btn-success"><i class="fa fa-arrow-left"></i> &nbsp; Back</a>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
							...
							<div class="card card-primary">
								...
								<form role="form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
									...
									<div class="card-body">
				                        ...
				                        @if($image)
				                        <div class="form-group">
				                        <img src="{{asset('public/type_image/'.$image)}}" width="70" height="70" />
				                    	</div>
				                        @endif
										...
										<div class="card-footer">
						                  	...
						                  	<a href="{{ route('admin.view.type') }}" class="btn btn-success">Back</a>
						                </div>
									</div>
									<!-- /.card-body -->
								</form>
