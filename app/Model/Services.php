...
class Services extends Model
{
    ...
    protected $fillable = [ 'name', 'image', 'price', 'discount', 'new_price', 'short_description', 'description' ];

    public $sortable = ['id', 'name', 'price', 'discount', 'new_price', 'created_at', 'updated_at'];
