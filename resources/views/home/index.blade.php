...
@section('content')
  ...
  <div class="main-content">
      ...
      <div class="rev_slider_wrapper">
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <!-- SLIDE 1 -->
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{ asset('public/site/images/bg/bg3.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('public/site/images/bg/bg3.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-white" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">We provides our best services for our clients and <br> try to achieve our client's trust and satisfaction.
              </div>
            ...
            <!-- SLIDE 2 -->
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{ asset('public/site/images/bg/bg1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('public/site/images/bg/bg1.jpg')}}"  alt=""  data-bgposition="center 40%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">Computer repair services 
              </div>
            ...
            <!-- SLIDE 3 -->
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{ asset('public/site/images/bg/bg4.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('public/site/images/bg/bg4.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Make Computer
              </div>
          ...
          $(".rev_slider").revolution({
            ...
            navigation: {
              ...
              bullets: {
                ...
                v_offset:30,
                space:5,
                tmp:'<span class="tp-bullet-img-wrap">  <span class="tp-bullet-image"></span></span><span class="tp-bullet-title">Itxpert</span>'
              }
            },
    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row equal-height-inner home-boxes" data-margin-top="-190px">
              ...
              <div class="sm-height-auto bg-theme-colored-lighter4">
                <div class="text-center pt-30 pb-sm-30">
                  <div class="icon-box text-center">
                    <a class="icon bg-silver-light icon-circled icon-xl" href="#"> <i class="fa fa-user text-theme-colored"></i> </a>
                    <h4 class="text-uppercase text-white-f1 font-weight-600">24 Hours Service</h4>
            ...
            <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay2">
              <div class="sm-height-auto bg-theme-colored-lighter3">
                <div class="text-center pt-30 pb-sm-30">
                  <div class="icon-box text-center">
                    <a class="icon bg-silver-light icon-circled icon-xl" href="#"> <i class="fa fa-comments-o text-theme-colored"></i> </a>
                    <h4 class="text-uppercase text-white-f1 font-weight-600">Online Help</h4>
                    <p class="text-white-f2 p-10">Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row pb-10">
            <div class="col-md-12 text-center">
              ...
              <a class="btn btn-theme-colored btn-lg text-uppercase text-white font-13 mt-30" href="#">Read More</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid pt-0 pb-0">
        <div class="row equal-height">
          <div class="col-md-4 bg-theme-colored sm-height-auto">
            <div class="p-50 pt-40 p-sm-0 pl-sm-40 p-sm-0 pt-sm-40 pb-sm-70">
              <h3 class="text-uppercase title text-white">Our Facilities</h3>
              <ul class="list list-white check font-15">
                <li><a href="#">Worldclass Expert Engineers</a></li>
                <li><a href="#">Ontime Delivery</a></li>
                <li><a href="#">Immergency Services</a></li>
                <li><a href="#">Online Help</a></li>
                <li><a href="#">24/7 Services</a></li>
                <li><a href="#">Outdoor Services</a></li>
                <li><a href="#">Guaranteed Work</a></li>
                <li><a href="#">Low Cost Services</a></li>
                <li><a href="#">Online services care</a></li>
              </ul>
              <a href="page-services-engine.html" class="btn btn-default btn-circled mt-10">view details</a>
            </div>
          </div>
          <div class="col-md-4 bg-white-f1 sm-height-auto">
            <div class="pt-40 pb-20 pl-30 pt-sm-40 pb-sm-40 pr-30 p-md-30">
              <h3 class="text-uppercase title">Our <span class="text-theme-color-2 font-weight-700">Working Skill</span></h3>
          ...
          <div class="col-md-4 bg-img-cover sm-height-auto" data-bg-img="{{ asset('public/site/images/bg/bg2.jpg')}}"></div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div class="container pt-70">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mt-0 line-height-1">Our <span class="text-theme-color-2"> Services</span></h2>
            </div>
          </div>
        </div>
        <div class="section-content">
              ...
              <div class="owl-carousel-3col" data-dots="true">
                <div class="item mb-10">
                  <div class="image-box-thum">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/photos/1.jpg')}}">
                  </div>
                  <div class="image-box-details bg-lighter p-15 pt-20 pb-sm-20">
                    <h3 class="title mt-0 mb-5">
                    ...
                    <ul class="list-inline project-conditions text-center bg-deep m-0 p-10">
                      <li class="current-fund"><strong>Price</strong>Pre- $2500</li>
                      <li class="target-fund"><strong>Discount</strong>85%</li>
                      <li class="remaining-days"><strong>Price</strong>New- $500</li>
                    </ul>
                  </div>
                </div>
                <div class="item mb-10">
                  <div class="image-box-thum">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/photos/2.jpg')}}">
                  </div>
                  <div class="image-box-details bg-lighter p-15 pt-20 pb-sm-20">
                    <h3 class="title mt-0 mb-5"><a href="#">Laptop Repair</a></h3>
                    <p class="desc mb-10">Lorem ipsum dolor sit ametcon secte adipisicing elit Sintume likumta.</p>
                    <div class="progress-item mt-0">
                      <div class="progress mb-10">
                        <div data-percent="85" class="progress-bar"><span class="percent">0</span></div>
                ...
                <div class="item mb-10">
                  <div class="image-box-thum">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/photos/3.jpg')}}">
                  </div>
                  <div class="image-box-details bg-lighter p-15 pt-20 pb-sm-20">
                    <h3 class="title mt-0 mb-5"><a href="#">iPhone Repair</a></h3>
                    <p class="desc mb-10">Lorem ipsum dolor sit ametcon secte adipisicing elit Sintume likumta.</p>
                    <div class="progress-item mt-0">
                      <div class="progress mb-10">
                        <div data-percent="85" class="progress-bar"><span class="percent">0</span></div>
                ...
                <div class="item mb-10">
                  <div class="image-box-thum">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/photos/4.jpg')}}">
                  </div>
                  <div class="image-box-details bg-lighter p-15 pt-20 pb-sm-20">
                    <h3 class="title mt-0 mb-5"><a href="#">iPad Repair</a></h3>
                    <p class="desc mb-10">Lorem ipsum dolor sit ametcon secte adipisicing elit Sintume likumta.</p>
                    <div class="progress-item mt-0">
                      <div class="progress mb-10">
                        <div data-percent="85" class="progress-bar"><span class="percent">0</span></div>
                ...
                <div class="item mb-10">
                  <div class="image-box-thum">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/photos/5.jpg')}}">
                  </div>
                  <div class="image-box-details bg-lighter p-15 pt-20 pb-sm-20">
                    <h3 class="title mt-0 mb-5"><a href="#">Printer Repair</a></h3>
                    <p class="desc mb-10">Lorem ipsum dolor sit ametcon secte adipisicing elit Sintume likumta.</p>
                    <div class="progress-item mt-0">
                      <div class="progress mb-10">
                        <div data-percent="85" class="progress-bar"><span class="percent">0</span></div>
    ...
    <!-- Section: Experts 2 -->
    <section id="trainers" class="bg-black-222">
      <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="line-height-1 mt-10 mb-0 pb-10 text-white">Our<span class="text-theme-color-2"> Experts</span></h2>
            </div>
          </div>
        </div>
        <div class="section-content">
              ...
              <div class="owl-carousel-4col" data-dots="true">
                <div class="item bg-lighter">
                  <div class="team-member maxwidth400">
                    <div class="thumb"><img alt="" src="{{ asset('public/site/images/team/1.jpg')}}" class="img-fullwidth"></div>
                    <div class="info p-20 p-sm-10 ">
                      <h4>Jone doe <small>-Computer Specialist</small></h4>
                ...
                <div class="item bg-lighter">
                  <div class="team-member maxwidth400">
                    <div class="thumb"><img alt="" src="{{ asset('public/site/images/team/2.jpg')}}" class="img-fullwidth"></div>
                    <div class="info p-20 p-sm-10 ">
                      <h4>Jone doe <small>-Computer Specialist</small></h4>
                      <p>Lorem ipsum dolor sit amet, conse ctetur adipisi cing elit.</p>
                      <ul class="styled-icons icon-theme-colored icon-circled icon-dark icon-sm mt-15 mb-0">
                ...
                <div class="item bg-lighter">
                  <div class="team-member maxwidth400">
                    <div class="thumb"><img alt="" src="{{ asset('public/site/images/team/3.jpg')}}" class="img-fullwidth"></div>
                    <div class="info p-20 p-sm-10 ">
                      <h4>Jone doe <small>-Computer Specialist</small></h4>
                      <p>Lorem ipsum dolor sit amet, conse ctetur adipisi cing elit.</p>
                      <ul class="styled-icons icon-theme-colored icon-circled icon-dark icon-sm mt-15 mb-0">
                ...
                <div class="item bg-lighter">
                  <div class="team-member maxwidth400">
                    <div class="thumb"><img alt="" src="{{ asset('public/site/images/team/4.jpg')}}" class="img-fullwidth mb-0"></div>
                    <div class="info p-20 p-sm-10 ">
                      <h4>Jone doe <small>-Computer Specialist</small></h4>
                      <p>Lorem ipsum dolor sit amet, conse ctetur adipisi cing elit.</p>
                      <ul class="styled-icons icon-theme-colored icon-circled icon-dark icon-sm mt-15 mb-0">
        ...
        <div class="section-title mb-30">
          <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="mt-0 line-height-1 text-center mb-0">Pricing <span class="text-theme-color-2"> Table</span></h2>
            </div>
          </div>
        </div>
        <div class="section-content">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="pricing table-horizontal maxwidth400">
                <div class="row">
                  <div class="col-md-6">
                    <div class="thumb">
                    <img class="img-fullwidth mb-sm-0" src="{{ asset('public/site/images/about/as7.jpg')}}" alt="">
                    </div>
                  </div>
                  <div class="col-md-6 p-30 pl-sm-80">
                    <p class="text-white font-40">$100</p>
                    <h3 class="text-white mt-0">Computer Repair</h3>
                    <a class="btn btn-border btn-theme-colored btn-circled btn-lg btn-sm mt-15 pl-20 pr-20" href="#">Get Service</a> 
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="pricing table-horizontal maxwidth400">
                <div class="row">
                  <div class="col-md-6">
                    <div class="thumb">
                    <img class="img-fullwidth mb-sm-0" src="{{ asset('public/site/images/about/as8.jpg')}}" alt="">
                    </div>
                  </div>
                  <div class="col-md-6 p-30 pl-sm-80">
                    <p class="text-white font-40">$120</p>
                    <h3 class="text-white mt-0">Laptop Repair</h3>
                    <a class="btn btn-border btn-theme-colored btn-circled btn-lg btn-sm mt-15 pl-20 pr-20" href="#">Get Service</a> 
                  </div>
                </div>
              </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="pricing table-horizontal maxwidth400">
                <div class="row">
                  <div class="col-md-6">
                    <div class="thumb">
                    <img class="img-fullwidth mb-sm-0" src="{{ asset('public/site/images/about/as9.jpg')}}" alt="">
                    </div>
                  </div>
                  <div class="col-md-6 p-30 pl-sm-80">
                    <p class="text-white font-40">$80</p>
                    <h3 class="text-white mt-0">iPhone Repair</h3>
                    <a class="btn btn-border btn-theme-colored btn-circled btn-lg btn-sm mt-15 pl-20 pr-20" href="#">Get Service</a> 
                  </div>
                </div>
              </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="pricing table-horizontal maxwidth400">
                <div class="row">
                  <div class="col-md-6">
                    <div class="thumb">
                    <img class="img-fullwidth mb-sm-0" src="{{ asset('public/site/images/about/as10.jpg')}}" alt="">
                    </div>
                  </div>
                  <div class="col-md-6 p-30 pl-sm-80">
                    <p class="text-white font-40">$90</p>
                    <h3 class="text-white mt-0">iPad Repair</h3>
                    <a class="btn btn-border btn-theme-colored btn-circled btn-lg btn-sm mt-15 pl-20 pr-20" href="#">Get Service</a> 
                  </div>
                </div>
              </div>
    ...
    <!-- Section: Gallery -->
    <section class="divider parallax layer-overlay overlay-dark-8" data-bg-img="{{ asset('public/site/images/bg/bg3.jpg')}}" id="gallery">
     <div class="container pt-60 pb-40">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase mt-0 pb-0 mb-0 text-white">Project <span class="text-theme-color-2"> Gallery</span></h2>
            </div>
          </div>
        </div>
        <div class="section-content">
              ...
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/1.jpg')}}">
                  ...
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">Memory Replacement</h4>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/2.jpg')}}">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                  ...
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">Processor Replace</h4>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/3.jpg')}}">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                  ...
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">Monitor Repairing</h4>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/4.jpg')}}">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                        <li><a data-rel="prettyPhoto" href="images/gallery/4.jpg"><i class="fa fa-arrows"></i></a></li>
                      </ul>
                    </div> 
                  </div>
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">Baterry Changing</h4>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/5.jpg')}}">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                  ...
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">Laptop Servecing</h4>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img class="img-fullwidth" alt="" src="{{ asset('public/site/images/gallery/6.jpg')}}">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                        <li><a data-rel="prettyPhoto" href="images/gallery/6.jpg"><i class="fa fa-arrows"></i></a></li>
                      </ul>
                    </div> 
                  </div>
                  <div class="gallery-bottom-part text-center">
    ...
    <section class="">
      <div class="container pl-sm-10 pl-0 pb-sm-60 pt-50 pb-50">
        <div class="row equal-height">
          <div class="col-md-6 col-sm-12">
            <h3 class="bg-theme-colored p-15 pl-30 mb-0 text-white">Get A Service Now!</h3>
            <form id="volunteer_apply_form" class="bg-light p-30 pb-15" name="job_apply_form" action="http://html.kodesolution.live/m/repairpro/v3.0/demo/includes/become-volunteer.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6">
          ...
          <div class="col-md-6 col-sm-12 pl-40 pr-0 pb-0 pt-0 hidden-xs hidden-sm">
            <h3 class="text-uppercase title line-bottom ml-20">Our <span class="text-theme-color-2 font-weight-700">Features</span></h3>
